...
codec/port/wm8962/%.o: ../codec/port/wm8962/%.c codec/port/wm8962/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-codec-2f-port-2f-wm8962

clean-codec-2f-port-2f-wm8962:
	-$(RM) ./codec/port/wm8962/fsl_codec_wm8962_adapter.d ./codec/port/wm8962/fsl_codec_wm8962_adapter.o

.PHONY: clean-codec-2f-port-2f-wm8962
