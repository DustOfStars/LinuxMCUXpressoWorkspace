...
pin_labels:
- {pin_num: R10, pin_signal: GPIO_SNVS_00, label: 'J42[3]', identifier: Test_R10}
- {pin_num: P10, pin_signal: GPIO_SNVS_01, label: 'J42[4]', identifier: Test_P10}
...
- pin_list:
  ...
  - {pin_num: R10, peripheral: GPIO13, signal: 'gpio_io, 03', pin_signal: GPIO_SNVS_00, direction: INPUT, gpio_interrupt: kGPIO_NoIntmode, software_input_on: Enable,
    pull_up_down_config: Pull_Up, pull_keeper_select: Pull, open_drain: Disable}
  - {pin_num: P10, peripheral: GPIO13, signal: 'gpio_io, 04', pin_signal: GPIO_SNVS_01, direction: INPUT, gpio_interrupt: kGPIO_NoIntmode, software_input_on: Disable,
    pull_up_down_config: Pull_Up, pull_keeper_select: Pull, open_drain: Disable}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
...
void BOARD_InitPins(void) {
  ...
  /* GPIO configuration of Test_R10 on GPIO_SNVS_00_DIG (pin R10) */
  gpio_pin_config_t Test_R10_config = {
      .direction = kGPIO_DigitalInput,
      .outputLogic = 0U,
      .interruptMode = kGPIO_NoIntmode
  };
  /* Initialize GPIO functionality on GPIO_SNVS_00_DIG (pin R10) */
  GPIO_PinInit(GPIO13, 3U, &Test_R10_config);

  /* GPIO configuration of Test_P10 on GPIO_SNVS_01_DIG (pin P10) */
  gpio_pin_config_t Test_P10_config = {
      .direction = kGPIO_DigitalInput,
      .outputLogic = 0U,
      .interruptMode = kGPIO_NoIntmode
  };
  /* Initialize GPIO functionality on GPIO_SNVS_01_DIG (pin P10) */
  GPIO_PinInit(GPIO13, 4U, &Test_P10_config);
  ...
  IOMUXC_SetPinMux(
      ...
      1U);                                    /* Software Input On Field: Force input path of pad GPIO_SNVS_00_DIG */
  IOMUXC_SetPinMux(
